 ...
 */
public class ReadSalesOrderAdapter extends RecyclerView.Adapter<ReadSalesOrderAdapter.LeadsHolder> {
    private Context context;
    private List<SalesOrder> salesOrders = new ArrayList<>();

    public ReadSalesOrderAdapter(Context context, List<SalesOrder> salesOrders) {
