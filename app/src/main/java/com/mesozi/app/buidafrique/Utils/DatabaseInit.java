...
public class DatabaseInit {
    public static void buildCategoriesDB() {
        ...
        productCategories.add(new ProductCategory("Feasibility Studies", String.format(Locale.getDefault(), "%sfinance-management/market-strategic-planning-feasibility-research/", ip), 1));
        productCategories.add(new ProductCategory("Investment Appraisal", String.format(Locale.getDefault(), "%sfinance-management/market-strategic-planning-feasibility-research/", ip), 1));
        ...
        productCategories.add(new ProductCategory("Project Development Design", String.format(Locale.getDefault(), "%sfinance-management/option-design-appraisal/", ip), 1));
        ...
        productCategories.add(new ProductCategory("Development Cost Management", String.format(Locale.getDefault(), "%sfinance-management/quantity-surveying/89-2/", ip), 2));
